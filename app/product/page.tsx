...
const ProductPage = () => {
  ...
  return (
    <>
      ...
      {/* Referrer Script */}
      <Script
        src="https://tag-staging3.mention-me.com/api/v2/referreroffer/mm1c6ad7e0?situation=referrer_product_page&implementation=link"
      ...
      {referrerId && (
        <Script
          src="https://tag-staging3.mention-me.com/api/v2/refereefind/mm1c6ad7e0?situation=referee_product_page&implementation=embed"
          strategy="beforeInteractive"
        />
      )}
    </>
